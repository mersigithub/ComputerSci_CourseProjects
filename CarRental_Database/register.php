    ...
    <form action="register.php" method="post" name="form1">
        ...
        if (isset($_POST['register'])) {
            ...
            if ($user_matched > 0) {
                ...
                $result   = mysqli_query($mysqli, "INSERT INTO user(first_name,email,password) VALUES('$name','$email','$password')");
                ...
                if ($result) {
                    ...
                    echo "INSERT INTO user(first_name,email,password) VALUES('$name','$email','$password')";
                }
            }
        }
